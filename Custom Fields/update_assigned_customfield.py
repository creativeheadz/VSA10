...
def update_assigned_customfield(custom_field_id=None):
    ...
    if not use_default_value:
        value = input("Enter new custom field value: ")
    ...
    try:
        ...
        result = api.customFields(custom_field_id).updateAssigned.put(request_body)
        
        print("\nCustom field updated successfully:")
        print(json.dumps(result, indent=4))
        
    except Exception as e:
        print('\nUpdateAssignedCustomField raised an exception:')
        print(str(e))

if __name__ == "__main__":
    update_assigned_customfield()
