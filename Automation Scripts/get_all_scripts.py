...
__friendly_name__ = "Get All Scripts"

# Add parent directory to path to import config
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
import config

def get_all_scripts(top=50, skip=0):
    """
    Get a list of all automation scripts
    ...
    Returns:
        dict: The API response containing scripts
    """
    ...
    try:
        ...
        print('\nGetScripts raised an exception:')
        print(str(e))
        return None
