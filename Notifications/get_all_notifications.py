...
__friendly_name__ = "Get All Notifications"

def get_all_notifications(top=50, skip=0):
    """
    ...
    Returns:
        dict: The API response containing notifications
    """
    ...
    try:
        ...
        print('\nGetNotifications raised an exception:')
        print(str(e))
        return None
