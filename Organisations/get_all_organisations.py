...
__friendly_name__ = "Get All Organisations"

def get_all_organisations(top=50, skip=0):
    """
    ...
    Returns:
        dict: The API response containing organisations
    """
    ...
    try:
        ...
        print('\nGetOrganizations raised an exception:')
        print(str(e))
        return None
